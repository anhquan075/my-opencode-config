...
def main():
    ...
    test(
        ...
        "",
        expect_contains=["My OpenCode Config Commands", "Quick Start"],
    ...
    test(
        ...
        " ",
        expect_contains=["My OpenCode Config Commands"],
        expect_type="category-guide",
    )
    ...
    categories_with_guides = [
        ...
        ("config", "My OpenCode Config Configuration"),
    ...
    for cat, title in categories_with_guides:
        test(f"3.x Category '{cat}'", cat, expect_contains=[title])
    ...
    test(
        ...
        expect_contains=[
            "/test"
        ],  # "test" is action verb = high intent, shows /test workflow
        expect_type="task-recommendations",
    )
    ...
    test("5.1 Command with colon", "plan:fast", expect_type="command-details")
    ...
    test(
        ...
        "config",
        expect_contains=["My OpenCode Config Configuration", ".ck.json"],
    ...
    test(
        ...
        ".ck.json",
        expect_contains=["My OpenCode Config Configuration"],
        expect_type="comprehensive-docs",
    )
    ...
    test("7.1 Overview has correct type", "", expect_type="category-guide")

    test("7.2 Category has correct type", "fix", expect_type="category-guide")

    test("7.3 Command has correct type", "fix:fast", expect_type="command-details")

    test("7.4 Search has correct type", "nonexistent", expect_type="search-results")

    test("7.5 Task has correct type", "fix my bug", expect_type="task-recommendations")
