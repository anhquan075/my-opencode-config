---
description: "My OpenCode Config usage guide - just type naturally - Args: ['category|command|task description']"
---

Think harder.
All-in-one My OpenCode Config guide. Run the script and present output based on type markers.
